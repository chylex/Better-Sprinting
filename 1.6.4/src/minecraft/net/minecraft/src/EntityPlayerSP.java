...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public void onLivingUpdate()
    {
        ...
        else
        {
            ...
            if (((GuiSprint.allowDoubleTap && !isSprinting())||!GuiSprint.allowDoubleTap) && onGround && var4 && !isUsingItem() && !isPotionActive(Potion.blindness)){	
            	setSprinting(state);
            }
            GuiScreen.held=state;
            
            if (GuiSprint.allowDoubleTap && !GuiScreen.held && GuiScreen.stoptime==0 && onGround && !var3 && movementInput.moveForward >= var2 && !isSprinting() && var4 && !isUsingItem() && !isPotionActive(Potion.blindness)){
