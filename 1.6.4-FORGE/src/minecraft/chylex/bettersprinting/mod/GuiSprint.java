...
public class GuiSprint extends GuiScreen{
	...
	public void initGui(){
        ...
        buttonList.add(new GuiButton(200,width/2-100,height/6+168,parentScreen==null?98:200,20,I18n.getString("gui.done")));
        if (parentScreen==null)buttonList.add(new GuiButton(190,width/2+2,height/6+168,98,20,I18n.getString("options.controls")));
        updateButtons();
    }
