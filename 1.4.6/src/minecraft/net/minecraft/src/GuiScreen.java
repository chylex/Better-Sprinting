...
public class GuiScreen extends Gui
{
    ...
    public static boolean allowFlyingBoost = true;
    ...
    protected void saveSprint(){
    	try{
            ...
            printwriter.println((new StringBuilder()).append(keyBindSprint.keyCode).append("|").append(keyBindSprintToggle.keyCode).append("|").append(keyBindSneakToggle.keyCode).append("|").append(allowDoubleTap?1:0).append("|").append(allowFlyingBoost?1:0).toString());
            printwriter.close();
        }
  				...
  				for(String s="";(s=bufferedreader.readLine())!=null;){
  					try{
  						...
  						if (str!=null){
  							...
  							if (str.length>=5)GuiScreen.allowFlyingBoost=Integer.parseInt(str[4])==1;
  						}
