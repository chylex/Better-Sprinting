...
public class MovementInputFromOptions extends MovementInput
{
    ...
    public void updatePlayerMoveState()
    {
        ...
        // CHANGE
        sprint = GuiScreen.keyBindSprint.pressed;
        if (!sprint){
        	if (GuiScreen.keyBindSprintToggle.pressed){
        		sprintToggle=!sprintToggle;
        		GuiScreen.keyBindSprintToggle.pressed=false;
        	}
        	sprint=sprintToggle;
        }
        ...
        if (!sneak){
        	if (GuiScreen.keyBindSneakToggle.pressed){
        		sneakToggle=!sneakToggle;
        		GuiScreen.keyBindSneakToggle.pressed=false;
        	}
        	sneak=sneakToggle;
        }
        // END
